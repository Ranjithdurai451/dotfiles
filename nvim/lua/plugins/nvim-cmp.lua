return {
  ...
  dependencies = {
    ...
    -- "github/copilot.vim", -- Ensure Copilot plugin is also listed here
  },
  config = function()
    ...
    local smart_tab = function(opts)
      ...
      if vim.o.expandtab then
        ...
        if in_leading_indent then
          ...
          local previous_char = prefix:sub(#prefix, #previous_char + 1)
    ...
    cmp.setup({
      ...
      sources = cmp.config.sources({
        ...
        { name = "copilot" }, -- ADDED COPILOT SOURCE HERE
      }),
